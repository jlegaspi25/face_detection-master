...
your_image = face_recognition.load_image_file("James.jpg")
...
while True:
    ...
    # Only process every other frame for faster processing
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        # Scale back up face locations since the frame we detected in was scaled down to 1/4 size
        top *= 4
        right *= 4
        bottom *= 4
        left *= 4
